...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 14, 2020 at 10:05 PM
...
--
-- Table structure for table `penjualan_data_dp_faktur_penjualan`
--

CREATE TABLE `penjualan_data_dp_faktur_penjualan` (
  `id` int(11) NOT NULL,
  `deskripsi` text NOT NULL,
  `jumlah_dp` bigint(20) NOT NULL,
  `penjualan_form_faktur_penjualan_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- --------------------------------------------------------

--
-- Table structure for table `penjualan_form_faktur_penjualan`
--

CREATE TABLE `penjualan_form_faktur_penjualan` (
  `id` int(11) NOT NULL,
  `tanggal` date NOT NULL,
  `penjualan_form_pesanan_penjualan_id` int(11) NOT NULL,
  `penjualan_form_pengiriman_barang_id` int(11) NOT NULL,
...
CREATE TABLE `penjualan_form_pesanan_penjualan` (
  ...
  `biaya_pengiriman` bigint(20) NOT NULL,
  `total_biaya` bigint(20) NOT NULL,
  `is_biaya_kirim_done` tinyint(1) NOT NULL,
  `is_uang_muka` tinyint(1) NOT NULL,
  `is_uang_muka_done` tinyint(1) NOT NULL,
  `is_done` tinyint(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Indexes for table `penjualan_data_dp_faktur_penjualan`
--
ALTER TABLE `penjualan_data_dp_faktur_penjualan`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `INDEX faktur dp_penjualan` (`penjualan_form_faktur_penjualan_id`) USING BTREE;

--
-- Indexes for table `penjualan_form_faktur_penjualan`
--
ALTER TABLE `penjualan_form_faktur_penjualan`
  ADD PRIMARY KEY (`id`),
  ADD KEY `INDEX pesanan faktur_penjualan` (`penjualan_form_pesanan_penjualan_id`),
  ADD KEY `INDEX pengiriman faktur_penjualan` (`penjualan_form_pengiriman_barang_id`);
...
ALTER TABLE `penjualan_form_pengiriman_barang`
  ADD PRIMARY KEY (`id`),
  ADD KEY `INDEX form_pesanan pengiririman_barang` (`penjualan_form_pesanan_penjualan_id`) USING BTREE;
...
--
-- AUTO_INCREMENT for table `penjualan_data_dp_faktur_penjualan`
--
ALTER TABLE `penjualan_data_dp_faktur_penjualan`
...
--
-- Constraints for table `penjualan_form_faktur_penjualan`
--
ALTER TABLE `penjualan_form_faktur_penjualan`
  ADD CONSTRAINT `FK pesanan faktur_penjualan` FOREIGN KEY (`penjualan_form_pesanan_penjualan_id`) REFERENCES `penjualan_form_pesanan_penjualan` (`id`) ON UPDATE CASCADE;
