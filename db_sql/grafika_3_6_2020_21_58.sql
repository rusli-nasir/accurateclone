...
(9, 'Persediaan', 'Led-Pns-15', 'Led Panasonic 15 Watt', 3, 3, 'pcs', 100, 20000, 2000000, 3, '2020-06-03');
...
INSERT INTO `persediaan_harga_penjualan` (`id`, `persediaan_daftar_barang_id`, `harga1`, `harga2`, `harga3`, `diskon`, `persediaan_form_set_harga_penjualan_id`) VALUES
(1, 2, 50000, 80000, 100000, 0, 0),
(2, 3, 50000, 80000, 100000, 0, 0),
(10, 9, 35000, 0, 0, 0, 0);
