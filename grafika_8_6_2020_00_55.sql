...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 07, 2020 at 07:55 PM
...
INSERT INTO `pembelian_daftar_barang_pesanan_pembelian` (`id`, `persediaan_daftar_barang_id`, `qty_beli`, `harga_unit`, `diskon`, `subtotal`, `pembelian_form_pesanan_pembelian_id`) VALUES
(2, 14, 1000, 30000, 10, 27000000, 1),
(3, 15, 1000, 50000, 15, 42500000, 1);
...
(1, '2020-06-07', 3, 'Cibaduyut, Bandung', 'Restok Lampu LED', 69500000, 'JNT', 250000, 5, 3475000, 1, 6602500, 72877500, 0, 0);
