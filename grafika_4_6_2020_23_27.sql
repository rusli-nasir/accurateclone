...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 04, 2020 at 06:27 PM
...
--
-- Dumping data for table `persediaan_form_set_harga_penjualan`
--

INSERT INTO `persediaan_form_set_harga_penjualan` (`id`, `tanggal`, `keterangan`) VALUES
(9, '2020-06-04', 'Coba 1'),
(11, '2020-06-04', 'sadasdasd');
...
INSERT INTO `persediaan_harga_penjualan` (`id`, `persediaan_daftar_barang_id`, `harga_jual`, `diskon`, `persediaan_form_set_harga_penjualan_id`) VALUES
(13, 15, 60000, 0, 9),
(15, 13, 40000, 0, 9),
(16, 15, 1000000, 0, 11),
(17, 13, 1000000, 0, 11);
...
ALTER TABLE `persediaan_stok_barang`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `FK gudang` (`persediaan_daftar_gudang_id`),
  ADD KEY `FK barang` (`persediaan_daftar_barang_id`),
  ADD KEY `FK stok` (`persediaan_form_penyesuaian_stok_id`);
...
ALTER TABLE `persediaan_stok_barang`
  ...
  ADD CONSTRAINT `FK stok` FOREIGN KEY (`persediaan_form_penyesuaian_stok_id`) REFERENCES `persediaan_form_penyesuaian_stok` (`id`);
