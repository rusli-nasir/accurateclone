      ...
      <div class="card-body">
              ...
              <div class="col-6">
                ...
                <div class="mb-2">
                  ...
                  <form id="form_kas_bank">
                    ...
                    <div class="form-group ml-3 m-0">
                      <input type="checkbox" name="penerimaan" id="kas_bank" class="kas_bank">
                      <label for="penerimaan">Penerimaan</label>
                    </div>
                    <div class="form-group ml-3 m-0">
                      <input type="checkbox" name="pembayaran" id="kas_bank" class="kas_bank">
                      <label for="pembayaran">Pembayaran</label>
                    </div>
                    <div class="form-group ml-3 m-0">
                      <input type="checkbox" name="rekonsiliasi_bank" id="kas_bank" class="kas_bank">
              ...
              <div class="col-6">
                ...
                <div class="mb-2">
                  ...
                  <form id="form_rma">
                    ...
                    <div class="form-group ml-3 m-0">
                      <input type="checkbox" name="faktur_penjualan_rma" id="faktur_penjualan_rma" class="rma">
                      <label for="faktur_penjualan_rma">Faktur Penjualan</label>
                    </div>
        ...
        <div class="row pt-3 mt-3" style="border-top: 1px solid #ebebeb">
          <div class="col-12 d-flex flex-row-reverse">
            ...
            <button type="button" id="btn-save-pengguna" class="btn btn-primary btn-icon-split btn-lg ml-4">
              <span class="icon text-white-50">
