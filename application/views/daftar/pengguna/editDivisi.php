      ...
      <div class="card-body">
        ...
        <div class="row pt-3 mt-3" style="border-top: 1px solid #ebebeb">
          <div class="col-12 d-flex flex-row-reverse">
            ...
            <button type="button" id="btn-save-edit-pengguna" class="btn btn-primary btn-icon-split btn-lg ml-4">
              <span class="icon text-white-50">
                <i class="fas fa-save"></i>
              </span>
              <span class="text">Save</span>
            </button>
            <button type="button" id="btn-delete-pengguna" class="btn btn-danger btn-icon-split btn-lg ml-4">
              <span class="icon text-white-50">
