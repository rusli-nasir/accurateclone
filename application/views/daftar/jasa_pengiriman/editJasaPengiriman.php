  ...
  <div class="col-8 mx-auto">
    ...
    <div class="card">
      <div class="card-body">
        ...
        <form action="<?= base_url('Daftar/JasaPengiriman/editJasaPengiriman/' . $pengiriman['id']) ?>" id="form" method="post">

          <div class="form-group">
            <label for="nama">Nama Jasa Pengiriman<span style="color: red">*</span></label>
            <input type="text" class="form-control input" name="nama" id="nama" maxlength="80" value="<?= $pengiriman['nama'] ?>">
          ...
          <div class="d-flex flex-row-reverse">
            ...
            <a href="<?= base_url('Daftar/JasaPengiriman/hapusJasaPengiriman/' . $id) ?>" id="btn-delete-pengguna" class="btn btn-danger btn-icon-split btn-lg ml-3">
              <span class="icon text-white-50">
