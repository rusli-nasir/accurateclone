    ...
    <div class="card shadow mb-4">
      ...
      <div class="card-body">
        <div class="d-flex flex-row-reverse mt-2 mb-4">
          <a href="<?= base_url('Daftar/Pelanggan/tambahPelanggan'); ?>">
        ...
        <div class="table-responsive">
          <table class="table table-bordered" id="tablePemasok" width="100%" cellspacing="0">
            ...
            <tbody id="data-table-user">
              <?php $this->load->view('daftar/pelanggan/tablePelanggan', array('model' => $list_pelanggan)); // Load file view.php dan kirim data siswanya 
              ?>
            </tbody>
          </table>
        </div>
