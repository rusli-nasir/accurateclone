...
<div class="row">
  <div class="col-12">
    ...
    <form id="form" action="<?= base_url('Penjualan/PengirimanPesanan/editPengirimanPesanan/' . $id_pengiriman) ?>" method="post">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <div class="row d-flex align-items-center hide-any">
            <div class="col-6">
            ...
            <div class="col-12">
              ...
              <div class="table-responsive mt-3">
                <table class="table table-bordered" id="tableListBarangDiterima" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    <?php $this->load->view('penjualan/pengiriman_pesanan/listRowBarangPengirimanForEdit', array('model' => $list_barang_pengiriman, 'list_gudang' => $list_gudang)); // Load file view.php dan kirim data siswanya 
                    ?>
                  </tbody>
                </table>
              </div>
          ...
          <div class="d-flex flex-row-reverse mt-5 pt-3" style="border-top: 1px solid #ebebeb">
            <a href="<?= base_url('Penjualan/PengirimanPesanan'); ?>" class="btn btn-warning btn-icon-split btn-lg ml-3">
              <span class="icon text-white-50">
                <i class="fas fa-exclamation-triangle"></i>
              </span>
              <span class="text">Cancel</span>
            </a>
            <div href="<?= base_url('Penjualan/PengirimanPesanan/hapusPengirimanPesanan/' . $id_pengiriman . '/' . $data_form['id_pesanan']) ?>" id="btn-delete" class="btn btn-danger btn-icon-split btn-lg ml-3" style="cursor: pointer">
              <span class="icon text-white-50">
