...
<div class="row">
  <div class="col-12">
    <h4 class="mb-3">Tambah Pengiriman Pesanan Baru</h4>
    ...
    <form id="form" action="<?= base_url('Penjualan/PengirimanPesanan/tambahPengirimanPesanan') ?>" method="post">
      <div class="row mb-5">
        <div class="col-6">
          <div class="card">
            <div class="card-body">
...
<div id="modal-pilih-pesanan" class="custom-modal mx-auto">
  <div class="row" style="width: 100%;height: 100vh;">
    <div class="col-6 my-auto mx-auto">
      <div class="card" style="height: 80vh;overflow-y: auto;">
        <div class="card-body">
          <div class="d-flex justify-content-between">
            <h5 style="width: 100%">Pilih Pesanan Penjualan</h5>
            ...
            <div class="table-responsive">
              <table class="table table-bordered" id="tablePesanan" width="100%" cellspacing="0">
                ...
                <tbody id="data-table-pesanan">
                  <?php $this->load->view('penjualan/pengiriman_pesanan/tablePilihPesanan', array('model' => $list_pesanan)); // Load file view.php dan kirim data siswanya 
                  ?>
                </tbody>
              </table>
            </div>
