      ...
      <div class="col-12">
        ...
        <div class="table-responsive mt-3">
          <table class="table table-bordered" id="tableListBarangDiterima" width="100%" cellspacing="0">
            ...
            <tbody>
              <?php $this->load->view('penjualan/faktur_penjualan/listRowBarangPesananFakturPenjualan', array('list_barang' => $list_barang_pengiriman, 'list_gudang' => $list_gudang)); // Load file view.php dan kirim data siswanya 
              ?>
            </tbody>
          </table>
        </div>
