    ...
    <form id="form" action="<?= base_url('Penjualan/FakturPenjualan/editFakturPenjualan/' . $data_form['id_faktur']) ?>" method="post">
      ...
      <div class="card">
        <div class="card-body">
                ...
                <div class="col-6">
                  ...
                  <?php if ($data_form['is_row_dp'] == 0) { ?>
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="tanggal_kirim" value="<?= $data_form['tanggal_kirim'] ?>" readonly>
                    </div>
                  <?php } ?>
                  <div class="form-group">
            ...
            <div class="row mb-4">
              <div class="col-12">
                <div class="btn-group" role="group" aria-label="Basic example">
                  ...
                  <?php if ((int) $data_form['jumlah_dp'] > 0) { ?>
          ...
          <?php if ($data_form['is_row_dp'] == 0) { ?>
            <div class="row view-faktur" id="view_list_barang">
              <div class="col-12">
                ...
                <div class="table-responsive mt-3">
                  <table class="table table-bordered" id="tableListBarangDiterima" width="100%" cellspacing="0">
                    ...
                    <tbody>
                      <?php
                      if ($list_barang_pengiriman !== false)
                        $this->load->view('penjualan/faktur_penjualan/listRowBarangPesananFakturPenjualan', array('list_barang' => $list_barang_pengiriman, 'list_gudang' => $list_gudang)); // Load file view.php dan kirim data siswanya 
                      ?>
                    </tbody>
                  </table>
                </div>
          ...
          <div class="d-flex flex-row-reverse mt-5 pt-3" style="border-top: 1px solid #ebebeb">
            <a href="<?= base_url('Penjualan/FakturPenjualan'); ?>" class="btn btn-warning btn-icon-split btn-lg ml-3">
