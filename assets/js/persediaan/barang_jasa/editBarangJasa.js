...
$(document).ready(function () {
  {
    tipe = $('#val-tipe-barang').val();
    if (tipe == 'Persediaan')
      $("#tipe_barang1").prop("checked", true);
    else if (tipe == 'NonPersediaan')
      $("#tipe_barang2").prop("checked", true);
    else if (tipe == 'Servis')
      $("#tipe_barang3").prop("checked", true);
  }
  ...
  $('[data-toggle="datepicker"]').datepicker('setDate', $('#val-saldo-awal-tanggal').val());
